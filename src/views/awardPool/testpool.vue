          ...
          <swiper-slide v-for="(obj,index) in level_list" :key="index" >
               <div class="swipePageView firstPage" :class="getPoolPageStyle(obj.level)">
                         <div class="titile">
                          ...
                          <div class="poolPercent"  id="ssssLabe" ref="plabel">
                                {{obj.pool_rate}}
                          </div> 
                          <div class="group">
                                <div class="item">
...
export default {
  ...
  methods: {
    ...
    liquidFill (){//方法
    // console.log('s',this.$echarts);
    console.log('~',document.getElementById('ssssLabe'))
           
           var liquid = this.$echarts.init(document.getElementById('ssssLabe'));
           liquid.setOption({
               title: {//标题
                  text:'水球图',
                  textStyle: {//标题的样式
